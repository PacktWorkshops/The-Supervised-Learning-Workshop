...
class TestingActivity11(unittest.TestCase):
    ...
    def test_r_square_score(self):
        ...
        self.assertAlmostEqual(train_r_square_score, 0.97057898, places=4)
    ...
    def test_train_accuracy(self):
        ...
        self.assertAlmostEqual(train_accuracy, 0.99478879, places=4)
    ...
    def test_test_accuracy(self):
        ...
        self.assertAlmostEqual(test_accuracy, 0.99290780, places=4)
